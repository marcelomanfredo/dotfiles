...
vim.keymap.set(
    ...
    "<C-d>",
    "<C-d>zz",
    { desc = "Put cursor in the middle of the screen when jumping through the file" }
)
vim.keymap.set(
    "n",
    "<C-u>",
...
vim.keymap.set(
    ...
    "<leader>y",
    [["+y]],
    { desc = 'Yank: In normal mode, opens the cmd with "+y, allowing motion. In visual mode, yanks the selection' }
)
vim.keymap.set({ "n", "v" }, "<leader>d", [["_d]], {
    desc = 'Delete to void: In normal mode, opens the cmd with "_d, allowing motion. In visual mode, deletes the selection',
})
